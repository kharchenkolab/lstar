...
ds = extend_for_viewer(ds, compress=False)                                   # od_score, stats_*, markers_*, factor axes
                                                                             # (compress=False: this is a format-round-trip
                                                                             # seed, not a viewer-compression fixture)
